...
const VisaPage = ({
  ...
  selectedVisa: Visa | undefined
  setSelectedVisa: Dispatch<Visa | undefined>
}) => {
  ...
  const CreateMock = () => {
    setSelectedVisa(
      iVisasMock.find((service: Visa) => service?.id == parseInt(id))
    )
    setIsMock(true)
  }
  ...
  return (
    <div className="page-details-wrapper">
      <Link className="return-link" to="/visas">
        Назад
      </Link>

      <div className="left">
        <img src={isMock ? mockImage : selectedVisa?.image} alt="" />
      </div>
